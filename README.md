...
- A **Spring Boot backend** that handles OAuth authentication and Gmail API communication
- A **React + TypeScript frontend** for interacting with labels via a modern UI
...
Detailed instructions are provided in each sub-project.
